...
!function (t) {
    ...
    return n.htmlInit = function (i, o) {
        e(function () {
            for (var e = n.toDashed(o), s = document.querySelectorAll(".js-" + e), a = "data-" + e + "-options", l = 0, c = s.length; c > l; l++) {
                var h, d = s[l], p = d.getAttribute(a);
                try {
                    h = p && JSON.parse(p)
                } catch (u) {
    ...
    var h = e("transform"), d = !!e("perspective");
    ...
    var h = t.jQuery, d = t.getComputedStyle, p = t.console, u = 0, f = {};
    c.defaults = {
        accessibility: !0,
        cellAlign: "center",
    ...
    var c = {touchstart: !0, MSPointerDown: !0}, h = {INPUT: !0, SELECT: !0};
    ...
    return n.prototype.pointerUp = function (i, n) {
        var o = e.getPointerPoint(n), s = this.tapElement.getBoundingClientRect(),
            a = r ? t.pageXOffset : document.body.scrollLeft, l = r ? t.pageYOffset : document.body.scrollTop,
    ...
    var c = t.jQuery, h = t.console, d = "undefined" != typeof h, p = Object.prototype.toString;
